    ...
    <div className="space-y-8">
      <div className="flex flex-col justify-between gap-6 md:flex-row md:items-center">
        ...
        <div className="flex flex-col gap-3 md:flex-row">
          ...
          <Link href="/panel/programs" className="flex items-center gap-2 rounded-xl bg-accent px-6 py-3 font-bold text-accent-foreground transition-all hover:opacity-90">
