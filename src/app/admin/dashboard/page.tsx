    ...
    <div className="space-y-8 text-slate-800">
      ...
      <div>
        <div className="mb-3 flex items-center justify-between">
          ...
          <Link href="/admin/financials" className="text-[10px] font-bold uppercase text-slate-500 hover:text-[#FF6B00]">
            Detayli Rapor
          </Link>
        </div>
            ...
            <div className="space-y-6 lg:col-span-4">
              ...
              <div className="panel-surface p-5">
                <div className="mb-4 flex items-center justify-between">
                  ...
                  <Link href="/admin/calendar" className="text-[10px] font-bold text-[#FF6B00] hover:underline">
                    Tumunu Gor
                  </Link>
                </div>
