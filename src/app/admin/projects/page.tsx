    ...
    <div className="space-y-8">
      <div className="flex flex-col justify-between gap-6 md:flex-row md:items-center">
        ...
        <PermissionGate permission="projects.export">
          <ExportButtons endpoint="/admin/projects/export" filename="projeler" buttonLabel="Projeleri Disa Aktar" />
        </PermissionGate>
      </div>
            ...
            <div key={project.id} className="glass-panel rounded-3xl border-white/10 p-6">
              ...
              <div className="mt-6 flex items-center justify-between gap-2 border-t border-white/5 pt-4">
                ...
                <div className="flex items-center gap-2">
                  <Link href={`/admin/projects/${project.id}`} className="inline-flex items-center gap-1 rounded-xl border border-white/10 bg-white/5 px-3 py-2 text-[10px] font-bold uppercase tracking-widest text-slate-900 transition-colors hover:bg-white/10">
                    Detay
                  </Link>
                  <PermissionGate permission="projects.content.update">
                    <Link href={`/admin/projects/${project.id}/content`} className="inline-flex items-center gap-1 rounded-xl border border-white/10 bg-indigo-600/20 px-3 py-2 text-[10px] font-bold uppercase tracking-widest text-indigo-300 transition-colors hover:bg-indigo-600/40 hover:text-white">
