...
export default function StaffAnnouncementsPage() {
  ...
  useEffect(() => {
    const loadAnnouncements = async () => {
      try {
        const response = await api.get<{ announcements: PaginatedAnnouncements }>("/staff/announcements");
    ...
    <div className="space-y-8">
      <div className="flex flex-col justify-between gap-6 md:flex-row md:items-center">
        ...
        {canExportAnnouncements && (
          <ExportButtons endpoint="/staff/announcements/export" filename="personel_duyurulari" buttonLabel="Duyurulari Disa Aktar" />
        )}
      </div>
