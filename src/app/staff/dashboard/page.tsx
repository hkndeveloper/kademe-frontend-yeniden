    ...
    const loadDashboard = async () => {
      try {
        const announcementsPromise = hasPermission("announcements.view")
          ? api
              .get<{ announcements: PaginatedAnnouncements }>("/staff/announcements")
    ...
    <div className="space-y-8">
      <div className="flex flex-col justify-between gap-6 md:flex-row md:items-center">
        ...
        <div className="flex gap-3">
          <Link href="/staff/calendar" className="flex items-center gap-2 rounded-xl border border-white/10 px-5 py-2 text-xs font-bold uppercase tracking-widest transition-all hover:bg-white/5">
            <Calendar className="h-4 w-4" />
            Takvim
          </Link>
          <Link href="/staff/support" className="rounded-xl border border-white/10 px-5 py-2 text-xs font-bold uppercase tracking-widest transition-all hover:bg-white/5">
            Destek
          </Link>
          <Link href="/staff/profile" className="rounded-xl bg-amber-500 px-5 py-2 text-xs font-bold uppercase tracking-widest text-white shadow-lg shadow-amber-500/20">
            Profilim
          </Link>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        <div className="glass-panel rounded-3xl p-8 lg:col-span-1">
          ...
          <Link href="/staff/calendar" className="mt-4 block text-center text-xs font-bold uppercase tracking-widest text-amber-500 hover:text-amber-400">
            Takvimde Tumunu Gor
          </Link>
        </div>
        ...
        <div className="glass-panel rounded-3xl p-8 lg:col-span-1">
          ...
          <Link href="/staff/requests" className="mt-6 flex items-center justify-center gap-2 rounded-xl bg-white/5 px-4 py-3 text-xs font-bold uppercase tracking-widest text-slate-900 transition-colors hover:bg-white/10">
