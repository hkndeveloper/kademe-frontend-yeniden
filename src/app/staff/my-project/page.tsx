...
export default function StaffMyProjectPage() {
  ...
  useEffect(() => {
    const loadProjects = async () => {
      try {
        const response = await api.get<StaffProjectsResponse>("/staff/projects");
    ...
    <div className="space-y-8">
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
        ...
        <PermissionGate permission="projects.export">
          <ExportButtons endpoint="/staff/projects/export" filename="personel_projeleri" buttonLabel="Projeleri Disa Aktar" />
        </PermissionGate>
      </div>
