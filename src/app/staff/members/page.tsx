...
export default function StaffMembersPage() {
  ...
  useEffect(() => {
    const loadMembers = async () => {
      try {
        const response = await api.get<{ members: PaginatedMembers; unit?: string | null; message?: string }>("/staff/members");
    ...
    <div className="space-y-8">
      <div className="flex flex-col justify-between gap-6 md:flex-row md:items-center">
        ...
        <PermissionGate permission="staff.export">
          <ExportButtons endpoint="/staff/members/export" filename="birim_uyeleri" params={{ search: search || undefined }} buttonLabel="Uyeleri Disa Aktar" />
        </PermissionGate>
      </div>
