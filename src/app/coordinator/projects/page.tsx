  ...
  return (
    ...
    <div className="space-y-8">
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-start">
        ...
        >
        <ExportButtons endpoint="/admin/projects/export" filename="koordinator_projeleri" buttonLabel="Projeleri Disa Aktar" />
        </PermissionGate>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        {projects.map((project) => (
          <div key={project.id} className="glass-panel rounded-3xl p-6">
            ...
            <Link href={`/coordinator/projects/${project.id}/content`} className="mt-6 inline-flex items-center gap-2 rounded-2xl bg-accent px-5 py-3 text-sm font-bold text-accent-foreground">
