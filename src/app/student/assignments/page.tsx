    ...
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Aktif proje dönemlerinize ait ödevler ve teslim durumları.</p>
        </div>
      </div>

      <div className="grid grid-cols-1 gap-6">
        {assignments.length === 0 ? (
          <div className="glass-panel rounded-3xl p-20 text-center text-muted-foreground">Henüz atanmış bir ödev görünmüyor.</div>
        ) : (
              ...
              >
                <div className="flex flex-col justify-between gap-6 md:flex-row md:items-start">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 rounded-xl bg-primary px-5 py-3 text-sm font-bold text-slate-900"
                  >
