  ...
  useEffect(() => {
    const fetchBohca = async () => {
      try {
        ...
        console.error("Bohca verileri cekilemedi", error);
      } finally {
        setLoading(false);
      }
    };
      ...
      <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-center">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm font-bold uppercase tracking-widest text-muted-foreground">Paylasilan egitim materyalleri</p>
          </div>
        </div>
